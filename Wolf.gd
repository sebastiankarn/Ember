...
@onready var agent_rid: RID = NavigationServer2D.agent_create()
...
func _physics_process(_delta):
	pass
	#var test_path = NavigationServer2D.map_get_path(agent_rid, global_position, target.global_position, false)
	#print(test_path)
