...
func on_success():
	...
	label.set("custom_colors/font_color", Color("3eff00"))
	label.show()
	...
	tween2.interpolate_property(item_texture, 'rect_scale', Vector2(1, 1), Vector2(2.2, 2.2), 0.3, Tween.TRANS_QUART, Tween.EASE_OUT)
	tween2.interpolate_property(item_texture, 'rect_scale', Vector2(2.2, 2.2), Vector2(1, 1), 0.3, Tween.TRANS_QUART, Tween.EASE_IN, 0.3)
	tween1.start()
	tween2.start()
...
func on_failure():
	...
	tween2.interpolate_property(item_texture, 'rect_scale', Vector2(1, 1), Vector2(0.7, 0.7), 0.3, Tween.TRANS_QUART, Tween.EASE_OUT)
	tween2.interpolate_property(item_texture, 'rect_scale', Vector2(0.7, 0.7), Vector2(1, 1), 0.3, Tween.TRANS_QUART, Tween.EASE_IN, 0.3)
