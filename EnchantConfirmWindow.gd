...
func on_success():
	...
	label.show()
	tween1.tween_property(get_node("NinePatchRect/VBoxContainer/VBoxContainer/HBoxContainer/TextureRect"), 'modulate', Color(3,3,3), 0.3).set_trans(Tween.TRANS_QUART).set_ease(Tween.EASE_OUT)
	tween1.tween_property(get_node("NinePatchRect/VBoxContainer/VBoxContainer/HBoxContainer/TextureRect"), 'modulate', Color(1,1,1), 0.3).set_trans(Tween.TRANS_QUART).set_ease(Tween.EASE_IN)
	...
	tween2.tween_property(item_texture, 'scale', Vector2(2.2, 2.2), 0.3).set_trans(Tween.TRANS_QUART).set_ease(Tween.EASE_OUT)
	tween2.tween_property(item_texture, 'scale', Vector2(1, 1), 0.3).set_trans(Tween.TRANS_QUART).set_ease(Tween.EASE_IN)
...
func on_failure():
	...
	label.show()
	tween1.tween_property(get_node("NinePatchRect/VBoxContainer/VBoxContainer/HBoxContainer/TextureRect"), 'modulate', Color(0.5,0.5,0.5), 0.6).set_trans(Tween.TRANS_QUART).set_ease(Tween.EASE_OUT)
	tween1.tween_property(item_texture, 'modulate', Color(0,0,0), 0.6).set_trans(Tween.TRANS_QUART).set_ease(Tween.EASE_OUT)
	tween2.tween_property(item_texture, 'scale', Vector2(0.7, 0.7), 0.3).set_trans(Tween.TRANS_QUART).set_ease(Tween.EASE_OUT)
	tween2.tween_property(item_texture, 'scale', Vector2(1, 1), 0.3).set_trans(Tween.TRANS_QUART).set_ease(Tween.EASE_IN)
